...
| 12  | [Desktop Core Port](desktop/core-port.md)   | ⏳ In Progress | Secondary, optional desktop client on Tauri — on-device inference, connector framework, grammar-constrained tool-calling, minimal offline chat UI (12.1–12.7, 12.7a done); 12.8 (writing-assist modes) scoped, not started |
