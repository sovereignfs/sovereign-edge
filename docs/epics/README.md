...
| 14  | [Desktop Distribution & Signing](desktop/distribution.md) | 📋 Not Started | Real signed/notarized installer artifacts and a self-update mechanism — no app store to piggyback on |
