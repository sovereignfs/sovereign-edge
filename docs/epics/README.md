...
| 13  | [Desktop App Shell](desktop/app-shell.md)   | ⏳ In Progress | Real navigation, model manager, connectors/permissions, and settings screens — extracted from task 12.7's single chat screen; nav scaffold (13.1) and model manager (13.2) done |
